 ...
 * Original file: /npm/leaflet-simple-map-screenshoter@0.5.0/dist/leaflet-simple-map-screenshoter.js
 *
  ...
  var o = n(function (e, n) {
      !(function (t) {
        const n = {
          ...
          getAndEncode: function (e) {
            ...
            return (
              t || ((t = { url: e, promise: null }), h.impl.urlCache.push(t)),
              null === t.promise &&
                (h.impl.options.cacheBust &&
                  (e += (/\?/.test(e) ? "&" : "?") + new Date().getTime()),
                (t.promise = new Promise(function (t) {
                  ...
                  (o.onreadystatechange = function () {
                    ...
                    (o.responseType = "blob"),
                    (o.timeout = n),
                    h.impl.options.useCredentials && (o.withCredentials = !0),
                    o.open("GET", e, !0),
                    o.send(),
            ...
            .then(function (e) {
              ...
              return (
                e.forEach(function (e) {
                  if (Object.getPrototypeOf(e).hasOwnProperty("cssRules"))
                    try {
        ...
        function p(e, t) {
          var o = (t = t || {});
          return (
            void 0 === o.imagePlaceholder
              ? (h.impl.options.imagePlaceholder = u.imagePlaceholder)
              : (h.impl.options.imagePlaceholder = o.imagePlaceholder),
            void 0 === o.cacheBust
              ? (h.impl.options.cacheBust = u.cacheBust)
              : (h.impl.options.cacheBust = o.cacheBust),
            void 0 === o.useCredentials
              ? (h.impl.options.useCredentials = u.useCredentials)
              : (h.impl.options.useCredentials = o.useCredentials),
            Promise.resolve(e)
              .then(function (e) {
          ...
          return p(e, t)
            ...
            .then(function (o) {
              ...
              const i = (function (e, o) {
                  ...
                  if (
                    ((r.width = (t.width || n.width(e)) * o),
                    (r.height = (t.height || n.height(e)) * o),
                    t.bgcolor)
                  ) {
              ...
              return (
                ...
                o && (a.scale(r, r), a.drawImage(o, 0, 0)),
                y &&
    ...
    i = L.Control.extend({
      options: {
        ...
        domtoimageOptions: {},
        position: "topleft",
        screenName: "" + new Date().toISOString().slice(0, 10) + "_route",
        iconUrl:
      ...
      onAdd: function () {
        return (
          ...
          !1 === this.options.hidden && this._addScreenBtn(),
          (this._onUserStartInteractWithMap =
            this._onUserStartInteractWithMap.bind(this)),
          (this._onUserEndInteractWithMap =
            this._onUserEndInteractWithMap.bind(this)),
      ...
      takeScreen: function () {
        ...
        for (var r in this.options)
          n.hasOwnProperty(r) ? (o[r] = n[r]) : (o[r] = this.options[r]);
        return 2 === this._screenState.status
          ? this._screenState.promise
          : (this._map.fire("simpleMapScreenshoter.takeScreen"),
            (this._screenState.status = 2),
            this._setElementsVisible(!1),
            (this._screenState.promise = this._waitEndOfInteractions()
              ...
              .then(function (t) {
                return (
                  (e._screenState.status = 1),
                  e._map.fire("simpleMapScreenshoter.done"),
                  t
                );
              })
              .catch(function (t) {
                return (
                  e._setElementsVisible(!0),
                  (e._screenState.status = 1),
      ...
      _canvasToImage: function (e, t) {
        var n = t.mimeType,
          o = e.toDataURL(n);
        return -1 === o.indexOf("base64")
          ? Promise.reject(new Error("Base64 image generation error"))
          : Promise.resolve(o);
      },
      ...
      _toCanvas: function (e, t) {
        ...
        if (!0 === this.options.cropImageByInnerWH) {
          ...
          (M = I.min),
            ...
            ((0 === M && 0 === C) || null === C) && (C = u),
            ((0 === w && 0 === T) || null === T) && (T = l),
            !0 === this.options.debugMode &&
              (console.log("emptyYLine", L),
              console.log("minMaxY", S),
              console.log("emptyXLine", j),
              console.log("minMaxX", I),
              console.log("debugX", {}),
              console.log("debugY", {})),
            (0 === w && T === l && 0 === M && C === u) ||
        ...
        return (
          ...
          null !== A &&
            ((m.height = m.height + (n + r + n)),
            g.beginPath(),
            g.rect(0, 0, m.width, m.height),
            (g.fillStyle = s),
            g.fill(),
            g.save()),
          g.drawImage(h, M, w, v, y, 0, 0, v, y),
          null !== A &&
            ((g.font = r + "px " + i),
            (g.fillStyle = a),
            g.fillText(A, n, y + n + r)),
          Promise.resolve(m)
        );
      },
        ...
        return (
          ...
          o
            ...
            .catch(function (o) {
              return (
                i(),
                n.scrollHeight >= 4e3 || n.scrollWidth >= 4e3
                  ? e.options.onPixelDataFail({
                      plugin: e,
                      node: n,
                      mapPane: r,
                      error: o,
        ...
        this._map.fire("simpleMapScreenshoter.click"),
          this.options.preventDownload ||
            this.takeScreen()
              .then(function (t) {
                var n =
                  "function" == typeof e.options.screenName
                    ? e.options.screenName.call(e)
                    : e.options.screenName;
                r.saveAs(t, n + ".png");
              })
              .catch(function (t) {
                e._map.fire("simpleMapScreenshoter.error", { e: t });
    ...
    a =
      ((L.Control.SimpleMapScreenshoter = i),
      (L.simpleMapScreenshoter = function (e) {
